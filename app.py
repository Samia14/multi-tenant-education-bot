...
quiz_page = st.Page("medical.py", title="Medical Bot", icon=":material/assignment:")
voice_page = st.Page("voice_chat.py", title="Listen Voice Response", icon=":material/voice_chat:")


pg = st.navigation([chat_page, voice_page,quiz_page])
st.set_page_config(page_title=" ChatBot", page_icon=":material/robot_2:")
pg.run()